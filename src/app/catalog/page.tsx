...
export default async function CatalogPage() {
  ...
  return (
    <>
      <Head>
        <title>Product Groups | Skyward Industries</title>
        <meta
          name="description"
          content="Explore our diverse range of industry-leading product groups at Skyward Industries."
        />
        <link rel="canonical" href="https://www.skywardparts.com/catalog" />
      </Head>
