...
export default async function PartInfoPage(props: {
  ...
  return (
    <>
      <Head>
        <title>NSN {cleanNSN} | Part Details</title>
        <meta
          name="description"
          content={`View details about NSN ${cleanNSN}, including manufacturer information, CAGE codes, and establishment details.`}
        />
        <link rel="canonical" href={`https://www.skywardparts.com/catalog/nsn-${cleanNSN}`} />
      </Head>
